...
const Navbar = () => {
    ...
    const backgroundImages = [
        'https://img.freepik.com/free-photo/beautiful-cloudscape-sunset-evening-dawn_53876-16471.jpg',
        'https://img.freepik.com/free-photo/city-lights-foggy-night_250224-352.jpg',
        'https://img.freepik.com/free-photo/low-angle-tree-with-starry-night-sky_23-2148282336.jpg'
    ];

    // Update background image index based on scroll position
    useEffect(() => {
        const handleScroll = () => {
            const scrollTop = window.pageYOffset || document.documentElement.scrollTop;
            const windowHeight = document.documentElement.scrollHeight - document.documentElement.clientHeight;

            // Calculate the scroll point to switch images (e.g., every 33% of page height)
            const imageIndex = Math.floor((scrollTop / windowHeight) * backgroundImages.length);
    ...
    return (
        <>
            ...
            {/* Main page with changing background */}
            <div
                style={{
                    minHeight: '200vh', // Make the page scrollable
                    ...
                    backgroundColor: '#0E101B', // Sets a background color to fill in any extra space
                    transition: 'background-image 0.5s ease-in-out'
                }}
            >
                {/* Navbar */}
                <nav
                    className="fixed top-0 left-0 right-0 z-10 transition-all duration-300 ease-in-out bg-transparent"
                    style={{
                        backdropFilter: 'blur(8px)',
                        fontFamily: '"Oswald", sans-serif',
                        padding: '1rem 2rem',
                        backgroundColor: 'rgba(17, 10, 51, 0.3)'
                    }}
                >
